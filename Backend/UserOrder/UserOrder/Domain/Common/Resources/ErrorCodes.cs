...
namespace UserOrder.Domain.Common.Resources
{
    ...
    {
        private static readonly string ErrorCodesFilePath = "D:\\Learning\\BoughtIt\\Backend\\UserOrder\\UserOrder\\Domain\\Common\\Resources\\ErrorCodes.json";
        private static Dictionary<string, ErrorDetail> _errorCodes;

        static ErrorCodes()
        {
            Console.WriteLine(ErrorCodesFilePath);
            LoadErrorCodes();
        }
